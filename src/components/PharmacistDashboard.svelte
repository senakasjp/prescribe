      ...
      <div class="flex justify-between items-center">
        <div class="flex items-center min-w-0 flex-1">
          ...
          <div class="min-w-0 flex-1">
            <h1 class="text-sm sm:text-base font-bold text-blue-600 truncate">M-Prescribe <span class="text-xs bg-blue-100 text-blue-800 px-1 py-0.5 rounded ml-1">v2.1.5</span></h1>
