  ...
  <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
    ...
    <div class="p-4">
      ...
      {:else if filteredPharmacists.length === 0}
        <div class="text-center py-8">
          <i class="fas fa-pills text-4xl text-gray-400 mb-3"></i>
          <h5 class="text-gray-500">No Available Pharmacists</h5>
      ...
      {:else}
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {#each filteredPharmacists as pharmacist}
            <div class="bg-white border-2 border-blue-200 rounded-lg shadow-sm h-full">
              <div class="p-4">
                <h6 class="text-lg font-semibold text-blue-600 mb-3">
                  {pharmacist.businessName}
                </h6>
                <p class="text-gray-500 text-sm mb-2">
                  <i class="fas fa-envelope mr-1"></i>
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 max-w-2xl shadow-lg rounded-md bg-white">
      <div class="bg-blue-600 text-white px-4 py-3 rounded-t-lg">
        <h5 class="text-lg font-semibold mb-0">
          ...
          <button type="button" class="text-white hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600 rounded-md p-1" on:click={closeConnectModal}>
            <i class="fas fa-times"></i>
          </button>
        </div>
        <div class="p-6">
        ...
        <div class="bg-gray-50 px-6 py-3 rounded-b-lg">
          <button type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 text-sm font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200" on:click={closeConnectModal}>
            <i class="fas fa-times mr-1"></i>
            Cancel
          </button>
          <button 
            type="button" 
            class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200 disabled:bg-gray-400 disabled:cursor-not-allowed ml-3"
            on:click={connectPharmacist}
            disabled={!pharmacistNumber || pharmacistNumber.length !== 6}
          >
            <i class="fas fa-link mr-1"></i>
