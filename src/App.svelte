<script>
  ...
  if (typeof window !== 'undefined') {
    ...
    window.buildTime = new Date().toISOString()
      console.log('🚀 M-Prescribe v2.2.14 loaded with multi-page header fix and increased margins!')
...
<main class="min-h-screen bg-gray-50" on:ai-usage-updated={handleAIUsageUpdate}>
  ...
  {:else if loading}
    <LoadingSpinner 
      size="large" 
      color="teal" 
        text="Loading M-Prescribe v2.2.14..."
      fullScreen={true}
    />
  {:else if user}
    ...
    <nav class="bg-teal-600 border-gray-200 dark:bg-gray-900">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span class="self-center text-xl font-semibold whitespace-nowrap text-white">M-Prescribe <span class="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded ml-2">v2.2.14</span></span>
        </a>
        ...
        <div class="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div class="bg-white px-6 py-8">
              ...
              <div class="mb-4">
               ...
               <h1 class="text-2xl font-bold text-gray-900 mb-2">M-Prescribe <span class="text-sm bg-blue-100 text-blue-800 px-2 py-1 rounded ml-2">v2.2.14</span> <span class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded ml-1">{new Date().toLocaleTimeString()}</span></h1>
